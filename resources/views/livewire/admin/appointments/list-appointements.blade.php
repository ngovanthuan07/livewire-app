                ...
                <div class="col-lg-12">
                    <div class="d-flex justify-content-between mb-2">
                                ...
                                <div class="btn-group ml-2">
                                    ...
                                    <div class="dropdown-menu" role="menu">
                                        <a wire:click.prevent="deleteSelectedRows" class="dropdown-item" href="#">Delete
                                            Selected</a>
                                        <a wire:click.prevent="markAllAsScheduled" class="dropdown-item" href="#">Mark
                                            as Scheduled</a>
                        ...
                        <div class="btn-group">
                            ...
                            <button wire:click="filterAppointmentsByStatus('scheduled')"
                                    class="btn {{$status === 'scheduled' ? 'btn-secondary' : 'btn-default'}}">
                                <span class="mr-1">Scheduled</span>
                                <span class="badge badge-pill badge-info">{{ $scheduleAppointmentCount }}</span>
                            </button>

                            <button wire:click="filterAppointmentsByStatus('closed')"
                                    class="btn {{$status === 'closed' ? 'btn-secondary' : 'btn-default'}}">
                                <span class="mr-1">Closed</span>
                                <span class="badge badge-pill badge-info">{{ $closedAppointmentCount }}</span>
                            </button>
                        </div>
                    </div>
                    <div class="card">
